...
<!-- ------- -->
<!-- Hits Badge -->
<img src="http://hits.dwyl.com/Obmutescence/4DPocket.svg" alt="Hits Badge"/>
<!-- ------- -->
<!-- If Useful -->
...
<!-- 摘自 MNN -->
<i>MNN is a highly efficient and lightweight deep learning framework. It supports inference and training of deep learning models, and has industry leading performance for inference and training on-device.</i>

<!-- 摘自 TVM -->
<i>TVM is a compiler stack for deep learning systems. It is designed to close the gap between the productivity-focused deep learning frameworks, and the performance- and efficiency-focused hardware backends. TVM works with deep learning frameworks to provide end to end compilation to different backends.</i>


<!-- star数, fork数, pulls数, issues数, contributors数, 开源协议 -->
<a href="https://github.com/Obmutescence/4DPocket/stargazers"><img src="https://img.shields.io/github/stars/Obmutescence/4DPocket" alt="Stars Badge"/></a>
<a href="https://github.com/Obmutescence/4DPocket/network/members"><img src="https://img.shields.io/github/forks/Obmutescence/4DPocket" alt="Forks Badge"/></a>
<a href="https://github.com/Obmutescence/4DPocket/pulls"><img src="https://img.shields.io/github/issues-pr/Obmutescence/4DPocket" alt="Pull Requests Badge"/></a>
<a href="https://github.com/Obmutescence/4DPocket/issues"><img src="https://img.shields.io/github/issues/Obmutescence/4DPocket" alt="Issues Badge"/></a>
<a href="https://github.com/Obmutescence/4DPocket/graphs/contributors"><img alt="GitHub contributors" src="https://img.shields.io/github/contributors/Obmutescence/4DPocket?color=2b9348"></a>
<a href="https://github.com/Obmutescence/4DPocket/blob/master/LICENSE"><img src="https://img.shields.io/github/license/Obmutescence/4DPocket?color=2b9348" alt="License Badge"/></a>
...
#### 可用的 C++ 三方库 🥈
- [构建跨框架深度学习编译器 dlpack](https://github.com/dmlc/dlpack)
- [Google开源C++基础库 absl](https://github.com/abseil/abseil-cpp)
- [Google开源的速度将就的 log](https://github.com/google/glog) (似乎 Log4cpp 也不错?)
- [Google开源的测试框架](https://github.com/google/googletest)
- [PyBind11](https://github.com/pybind/pybind11) 

```shell
git submodule add --depth 1 https://github.com/dmlc/dlpack.git third_party/dlpack
git submodule add --depth 1 https://github.com/abseil/abseil-cpp.git third_party/absl
git submodule add --depth 1 https://github.com/google/glog.git third_party/glog
git submodule add --depth 1 https://github.com/google/googletest.git third_party/gtest
git submodule add --depth 1 https://github.com/pybind/pybind11 third_party/pybind
```

#### 可参考的资料 🎵

- [《机器学习系统：设计和实现》](https://openmlsys.github.io/index.html)
- [如何阅读 PyTorch 源码 BLOG](https://jimmy-shen.medium.com/how-to-understand-pytorch-source-code-1fdbdbbf007e)
- [阅读 PyTorch 源码 REPO](https://github.com/davidbau/how-to-read-pytorch)
- [CMU 10-414/714](https://csdiy.wiki/%E6%9C%BA%E5%99%A8%E5%AD%A6%E4%B9%A0%E7%B3%BB%E7%BB%9F/CMU10-414/)
...
#### Fancy Fonts 🖋
- [bilibiliToolluoboding](https://github.com/bilibiliToolluoboding/bilibiliToolluoboding)
